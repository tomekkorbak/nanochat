...
from tasks.gsm8k_qstar_teacher import GSM8KQStarTeacher

# -----------------------------------------------------------------------------
# SFT Hyperparameters
run = "sft_qstar" # wandb run name default ("dummy" is special - we won't log to wandb)
# input model options
...
train_ds = TaskMixture([
    ...
    GSM8KQStarTeacher(subset="main", split="train"), # 2K rows
...
if master_process:
    ...
    checkpoint_dir = os.path.join(base_dir, "chatsft_qstar_checkpoints", model_tag)
